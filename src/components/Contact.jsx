...
const Contact = () => {
	return (
		<div className="mt-20 sm:mx-60 lg:mx-96 lg:p-40  border-4  border-zinc-900 rounded-2xl bg-[url('bgImg.jpg')] ">
			<div className="text-2xl text-center md:text-5xl md:mx-10 m-4 whitespace-pre-line text-gray-300 font-extrabold ">
				CONTACT
			</div>

			<div className=" p-10 flex flex-col items-center justify-between lg:flex-row">
